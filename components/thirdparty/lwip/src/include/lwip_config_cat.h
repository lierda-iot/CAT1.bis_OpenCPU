...
#ifdef CUSTOMER_CMCC_DM_ENABLE
#define TCPIP_MAX_ETH_PKG_DUMP_LEN   1450                
#else
...
/* lierda start: modified for kdzn ftp download bug by zhouwei 20240926 */
#ifdef FEATURE_NT26KCNB20NNB_Q1245_ENABLE
#define PBUF_POOL_SIZE                  72
#else
#define PBUF_POOL_SIZE                  8
#endif
/* lierda end: modified for kdzn ftp download bug by zhouwei 20240926 */
#endif
...
#define LWIP_RANDOMIZE_INITIAL_LOCAL_PORTS 1    // lierda modify
#endif
/**
 * @}
 */
 ...
 */
#if !defined TCP_MINRTX || defined __DOXYGEN__
#define TCP_MINRTX                      3        // from 4 to 3 modified by lierda
#endif
...
#define TCP_MAXRTX_TOTAL_TIME                      720    // from 600 to 720 modified by lierda
#endif
...
#define TCP_MINRTX_TOTAL_TIME                      3    // from 40 to 3 modified by lierda
#endif
...
#define TCP_DEFRTX_TOTAL_TIME                      10    // from 0 to 10 modified by lierda
#endif
...
#define TCP_SYNMAXRTX                   4          // form 5 to 4 modified by lierda
#endif
